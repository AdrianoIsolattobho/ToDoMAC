...
public class Controller {
    ...
    if (contenitoreToDoSca == null) {
        ...
        JLabel messaggioVuoto = new JLabel("Nessun todo in scadenza oggi", SwingConstants.CENTER);
        contenitoreToDoSca.setLayout(new BorderLayout());
        contenitoreToDoSca.add(messaggioVuoto, BorderLayout.CENTER);
